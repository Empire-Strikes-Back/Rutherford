...
;; store database uri
  ...
  (def uri "datomic:free://datomicfreedb:4334/seattle")
...
;; parse schema edn file
  (def schema-tx (read-string (slurp "src/seattle/seattle-schema.edn")))
...
;; parse seed data edn file
  (def data-tx (read-string (slurp "src/seattle/seattle-data0.edn")))
