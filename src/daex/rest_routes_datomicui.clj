(ns daex.rest-routes-datomicui
  (:require [clojure.java.io :as io]
            [clojure.core.async :as async]
            [datomic.api :as d]
            [clojure.edn :as edn]
            [daex.rest-db-datomicui :as dtm]
            [daex.rest-db-starcraft]
            [daex.rest-db-seattle]
            [clojure.pprint :as pp]
            [daex.datomic :refer [q-idents q-attrs]]
            [daex.impl :refer [try-parse-int]]
